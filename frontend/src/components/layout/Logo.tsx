...
const Logo: React.FC<LogoProps> = ({ size = 46, className = '' }) => {
  return (
    <svg 
      width={size} 
      height={size} 
    ...
    >
      ...
      <g fill="white" opacity="0.95">
        ...
        <line x1="26" y1="26" x2="28" y2="28" stroke="white" strokeWidth="2" strokeLinecap="round" />
        <line x1="38" y1="26" x2="36" y2="28" stroke="white" strokeWidth="2" strokeLinecap="round" />
        <line x1="26" y1="38" x2="28" y2="36" stroke="white" strokeWidth="2" strokeLinecap="round" />
        <line x1="38" y1="38" x2="36" y2="36" stroke="white" strokeWidth="2" strokeLinecap="round" />
      </g>
